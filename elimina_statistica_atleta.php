...
if (isset($_POST['id'])) {
    ...
    $sql_elimina = "DELETE FROM partecipa WHERE id = '$id'";
    if ($mydb->query($sql_elimina)) {
        echo json_encode(array('type' => 'Success', 'value' => "Statistiche eliminate con successo."));
    } else {
        echo json_encode(array('type' => 'Error', 'value' => "Errore durante l'eliminazione delle statistiche: " . $mydb->error));
    }
